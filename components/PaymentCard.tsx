...
import { Card, CardHeader, CardTitle, CardContent, CardFooter } from "dig";
...
export default function PaymentCard({ amount, trace, status, onViewDetails }: PaymentCardProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <div className="flex flex-col gap-3">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-mono text-sm">{trace}</span>
          </div>
      ...
      <CardFooter>
        <Button onClick={onViewDetails} size="sm" variant="outline" aria-label="مشاهده جزئیات">
